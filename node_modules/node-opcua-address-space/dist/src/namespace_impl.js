...
class NamespaceImpl {
    constructor(options) {
        ...
        (0, node_opcua_assert_1.assert)(typeof options.namespaceUri === "string");
        (0, node_opcua_assert_1.assert)(typeof options.index === "number");
    ...
    addMethod(parentObject, options) {
        ...
        (0, node_opcua_assert_1.assert)(Object.prototype.hasOwnProperty.call(options, "browseName"));
        (0, node_opcua_assert_1.assert)(!Object.prototype.hasOwnProperty.call(options, "inputArguments") || Array.isArray(options.inputArguments));
        (0, node_opcua_assert_1.assert)(!Object.prototype.hasOwnProperty.call(options, "outputArguments") || Array.isArray(options.outputArguments));
