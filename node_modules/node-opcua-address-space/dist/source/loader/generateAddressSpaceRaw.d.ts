 ...
 */
export declare function generateAddressSpaceRawCallback(addressSpace: IAddressSpace, xmlFiles: string | string[], xmlLoader: (nodeset2xmlUri: string, callback: CallbackT<string>) => void, callback?: ErrorCallback): void;
export declare type XmlLoaderFunc = (nodeset2xmlUri: string, callback: CallbackT<string>) => void;
export declare function generateAddressSpaceRaw(addressSpace: IAddressSpace, xmlFiles: string | string[], xmlLoader: XmlLoaderFunc): Promise<void>;
